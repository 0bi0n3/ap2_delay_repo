...
tresult PLUGIN_API delay_oneController::initialize (FUnknown* context)
{
    ...
    parameters.addParameter( STR16( "Delay 3" ), STR16( "sec" ), 0, 0.0, Vst::ParameterInfo::kCanAutomate, AudioParams::kParamDelayTime3Id, 0 );
    
    parameters.addParameter( STR16( "Delay 4" ), STR16( "sec" ), 0, 0.0, Vst::ParameterInfo::kCanAutomate, AudioParams::kParamDelayTime4Id, 0 );
    ...
    parameters.addParameter( STR16( "Feedback Gain 2" ), STR16( "dB" ), 0, 0.0, Vst::ParameterInfo::kCanAutomate, AudioParams::kParamFeedbackGain2Id, 0 );
    
    parameters.addParameter( STR16( "Feedback Gain 3" ), STR16( "dB" ), 0, 0.0, Vst::ParameterInfo::kCanAutomate, AudioParams::kParamFeedbackGain3Id, 0 );
    
    parameters.addParameter( STR16( "Feedback Gain 4" ), STR16( "dB" ), 0, 0.0, Vst::ParameterInfo::kCanAutomate, AudioParams::kParamFeedbackGain4Id, 0 );
